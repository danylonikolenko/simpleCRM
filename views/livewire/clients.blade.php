...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div>
            <button wire:click="create()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded my-3">Add Client</button>
            ...
            <table class="table-fixed w-full">
                ...
                @foreach($clients as $client)
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $client->contacts}}</td>
